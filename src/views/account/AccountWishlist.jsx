// src/views/account/AccountWishlist.jsx
...
import "../../styles/account/accountwishlist.css";
...
export default function AccountWishlist() {
  const { wishlistIds, fetchWishlistProducts, toggleWishlist } = useWishlist();
  ...
  return (
    <div className="account-wishlist">
      ...
      <div className="wishlist-grid">
        {products.map((p) => {
          const { precioOriginal, descuento, precioFinal, precioTransferencia } =
            calcularPrecios(p, discountRules);
                ...
                <div className="wishlist-card__pricing">
                  {descuento > 0 ? (
                    <>
                      ...
                      <span className="wishlist-card__price-final">
